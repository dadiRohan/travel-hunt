...
<head>
    ...
    <title>{{ config('app.name', 'Travel Hunt') }} - @yield('title')</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('travels.index') }}">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link @if(Route::currentRouteName() == 'travels.index') active @endif" href="{{ route('travels.index') }}">
                            <i class="fas fa-home"></i> Home
                        </a>
                    </li>
                    @auth
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('travels.create') }}">
